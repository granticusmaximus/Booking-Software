    ...
    public partial class initialdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookCarId = table.Column<int>(nullable: false)
                    ...
                    RecurrenceExDate = table.Column<DateTimeOffset>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookGeneralId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AllDay = table.Column<bool>(nullable: false),
                    Categorize = table.Column<string>(nullable: true),
                    CreateAtUtc = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookGeneral", x => x.BookGeneralId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookMeetingRoomId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AllDay = table.Column<bool>(nullable: false),
                    Categorize = table.Column<string>(nullable: true),
                    CreateAtUtc = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookMeetingRoom", x => x.BookMeetingRoomId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateBy = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    GeneralName = table.Column<string>(nullable: true),
                    UpdateAtUtc = table.Column<DateTime>(nullable: false),
                    UpdateBy = table.Column<string>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MyAgendaId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AllDay = table.Column<bool>(nullable: false),
                    Categorize = table.Column<string>(nullable: true),
                    CreateAtUtc = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyAgenda", x => x.MyAgendaId);
                });
